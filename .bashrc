...
alias aupgrade='cat ~/.key | sudo -S apt upgrade'
...
alias clog='cat ~/.key | sudo -S tail -f /var/log/syslog'
alias df='pydf'
alias du='ncdu -x'
alias free='free -m'
...
alias shutdown='cat ~/.key | sudo -S shutdown'
alias sysctl='systemctl'
alias syslog='cat ~/.key | sudo -S cat /var/log/syslog | less'
alias tcreate='cat ~/.key | sudo -S timeshift --create --comments'
alias tlist='cat ~/.key | sudo -S timeshift --list'
alias top='htop'
alias tremove='cat ~/.key | sudo -S timeshift --delete'
alias trestore='cat ~/.key | sudo -S timeshift --restore'
alias vi='micro'
