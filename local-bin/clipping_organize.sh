...
folders=$(ls -d /home/lwh/phone/Documents/Personal/*/)
...
#	echo "$folder_name" >> /home/lwh/1.txt
  	...
  	if grep -q "tags: $folder_name" "/home/lwh/phone/Documents/Personal/Clipping/${FILENAME}"; then
#  		echo "File $1 contains the letter $folder_name." >> /home/lwh/1.txt
  		mv "/home/lwh/phone/Documents/Personal/Clipping/$1" "/home/lwh/phone/Documents/Personal/$folder_name/"
#	else
