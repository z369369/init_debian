...
class PrefsWidget {
    constructor() {
        ...
        this._settings = ExtensionUtils.getSettings();
        // let status = this._settings.get_boolean('confirmation-dialog');
        ...
        this._checkButton.connect('notify::active', tickBox => {
            ...
            this._checkButton.set_label(tickBox.active ? 'Confirmation Enabled on logout, restart and power off, Safe!' : 'Oh no! no confirmation on logout, restart and poweroff, you know what it means, rite');
        });
