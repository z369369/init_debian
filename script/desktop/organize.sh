...
rsync -a --delete --exclude-from /home/lwh --exclude .var/app/org.gnome.Boxes --exclude .local/share/Trash --exclude .local/share/flatpak --exclude phone/Tachiyomi --exclude Games --exclude Downloads/iso --exclude .cache  ~/ /media/lwh/lwh_backup1/lwh/
