...
rsync -a --exclude-from /home/$USER --exclude phone/Tachiyomi --exclude Games --exclude Public --exclude Downloads --exclude .cache --exclude .var  /home/$USER/ /media/$USER/backup_disk/home/$USER/
